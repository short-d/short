...
func (s ShortLinkFake) GetByAlias(alias string) (entity.ShortLink, error) {
...
func (s ShortLinkFake) GetByAliases(aliases []string) ([]entity.ShortLink, error) {
	if len(aliases) == 0 {
	...
	for _, alias := range aliases {
		shortLink, err := s.GetByAlias(alias)
